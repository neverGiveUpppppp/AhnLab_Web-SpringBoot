...
@Component
@Aspect
@RequiredArgsConstructor // boardService를 쓰기위해서 넣음
@Slf4j
public class BoardAspect {
	
	private final BoardService boardService; // 이거 쓸려고 @RequiredArgsConstructor  이거 추가
	
	// @Pointcut 적용 전
//	@Before("execution(* com.example.controller.BoardController.edit(..))"
...
//		MethodSignature signature = (MethodSignature) point.getSignatrue();
